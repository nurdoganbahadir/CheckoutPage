const productRows = document.querySelector("#product-rowlari");
const productsSum = document.querySelector(".productstoplam");
const vergi = document.querySelector(".vergi");
